...
Begin VB.Form frmZonas 
   ...
   Begin TrueOleDBGrid80.TDBGrid tdbg1 
      ...
      Splits(0)._ColumnProps(14)=   "Column(2).Width=5847"
      ...
      Splits(0)._ColumnProps(26)=   "Column(4).Width=2831"
      Splits(0)._ColumnProps(27)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(28)=   "Column(4)._WidthInPix=2725"
      Splits(0)._ColumnProps(29)=   "Column(4)._EditAlways=0"
      Splits(0)._ColumnProps(30)=   "Column(4)._ColStyle=65792"
      Splits(0)._ColumnProps(31)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(32)=   "Column(5).Width=2619"
      Splits(0)._ColumnProps(33)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(34)=   "Column(5)._WidthInPix=2514"
   ...
   Begin LaVolpeAlphaImg.AlphaImgCtl cmdExit 
      ...
      _ExtentX        =   1270
      _ExtentY        =   1270
      Image           =   "Zonas.frx":0442
      Effects         =   "Zonas.frx":1147
   End
   Begin LaVolpeAlphaImg.AlphaImgCtl cmdPrint 
      ...
      _ExtentX        =   1270
      _ExtentY        =   1270
      Image           =   "Zonas.frx":115F
      Effects         =   "Zonas.frx":230A
   End
End
...
Private Sub cmdPrint_Click()
   ...
   Dim fE As clsEntity
   Dim cM As clsModule
   For Each cM In lEntity.localModule
      With cM
...
Private Sub Form_Activate()
   ...
   Dim mCol As Integer
   Set mList = Nothing
   cmdPrint.Enabled = (lEntity.localModule.Count >= 1)
   If lEntity.localModule.Count >= 1 Then
      frmZonas.Caption = "Situação Corrente das Zonas - " & lEntity.vDescr
      ' Allocate space for rows, 7 columns
      Set mList = New XArrayDB
      mList.ReDim 0, lEntity.localModule.Count - 1, 0, 6
      mRow = 0
      For Each cM In lEntity.localModule
         With cM
         ...
         End With
      Next
      mList.QuickSort 0, mRow - 1, 2, XORDER_ASCEND, XTYPE_STRING
      tdbg1.Array = mList
      tdbg1.ReBind
   End If
End Sub
...
Private Sub Form_Load()
   Dim success As Long
   success = SetWindowPos(frmZonas.hWnd, HWND_TOPMOST, 0, 0, 0, 0, FLAGS)
   curhwnd = frmZonas.hWnd
